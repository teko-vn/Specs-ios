...
Pod::Spec.new do |s|
  s.name             = 'CartUI'
  s.version          = '3.4.0-PICK-7502-7492.1'
  ...
  s.source           = {
                         :http => 'https://api.github.com/repos/teko-vn/Specs-ios/releases/assets/267778740',
                         :type => 'zip',
                         :headers => [
  ...
  # dependency
  # core
  s.dependency 'CartCore', '3.4.0-PICK-7502-7492.1'
