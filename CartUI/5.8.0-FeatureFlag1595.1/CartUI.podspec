...
Pod::Spec.new do |s|
  s.name             = 'CartUI'
  s.version          = '5.8.0-FeatureFlag1595.1'
  ...
  s.source           = {
                         :http => 'https://api.github.com/repos/teko-vn/Specs-ios/releases/assets/353499492',
                         :type => 'zip',
                         :headers => [
  ...
  # dependency
  # core
  s.dependency 'CartCore', '5.8.0-FeatureFlag1595.1'
