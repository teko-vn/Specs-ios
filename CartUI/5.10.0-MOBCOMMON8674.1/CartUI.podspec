...
Pod::Spec.new do |s|
  s.name             = 'CartUI'
  s.version          = '5.10.0-MOBCOMMON8674.1'
  ...
  s.source           = {
                         :http => 'https://api.github.com/repos/teko-vn/Specs-ios/releases/assets/386712148',
                         :type => 'zip',
                         :headers => [
  ...
  # dependency
  # core
  s.dependency 'CartCore', '5.10.0-MOBCOMMON8674.1'
