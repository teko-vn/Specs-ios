...
Pod::Spec.new do |s|
  s.name             = 'CartUI'
  s.version          = '6.3.0-OMNI1628-MOBCOMMON7565.1'
  ...
  s.source           = {
                         :http => 'https://api.github.com/repos/teko-vn/Specs-ios/releases/assets/443328943',
                         :type => 'zip',
                         :headers => [
  ...
  # dependency
  # core
  s.dependency 'CartCore', '6.3.0-OMNI1628-MOBCOMMON7565.1'
