...
Pod::Spec.new do |s|
  s.name             = 'CartUI'
  s.version          = '6.6.0-MOBCOMMON9311.1'
  ...
  s.source           = {
                         :http => 'https://api.github.com/repos/teko-vn/Specs-ios/releases/assets/488165125',
                         :type => 'zip',
                         :headers => [
  ...
  # dependency
  # core
  s.dependency 'CartCore', '6.6.0-MOBCOMMON9311.1'
  ...
  # Loyalty
  s.dependency 'LoyaltyComponent', '~> 5.1'
