...
Pod::Spec.new do |s|
  s.name             = 'CartUI'
  s.version          = '3.1.0-OMNI154015521553.1'
  ...
  s.source           = {
                         :http => 'https://api.github.com/repos/teko-vn/Specs-ios/releases/assets/246559600',
                         :type => 'zip',
                         :headers => [
  ...
  # dependency
  # core
  s.dependency 'CartCore', '3.1.0-OMNI154015521553.1'
