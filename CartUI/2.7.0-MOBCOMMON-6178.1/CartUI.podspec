...
Pod::Spec.new do |s|
  s.name             = 'CartUI'
  s.version          = '2.7.0-MOBCOMMON-6178.1'
  ...
  s.source           = {
                         :http => 'https://api.github.com/repos/teko-vn/Specs-ios/releases/assets/199146167',
                         :type => 'zip',
                         :headers => [
  ...
  # dependency
  # core
  s.dependency 'CartCore', '2.7.0-MOBCOMMON-6178.1'
