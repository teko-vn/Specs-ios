...
Pod::Spec.new do |s|
  s.name             = 'CartUI'
  s.version          = '5.4.0-MOBCOMMON-8186.3'
  ...
  s.source           = {
                         :http => 'https://api.github.com/repos/teko-vn/Specs-ios/releases/assets/314337977',
                         :type => 'zip',
                         :headers => [
  ...
  # dependency
  # core
  s.dependency 'CartCore', '5.4.0-MOBCOMMON-8186.3'
