...
Pod::Spec.new do |s|
  ...
  s.source           = {
                         :http => 'https://api.github.com/repos/teko-vn/Specs-ios/releases/assets/509865573',
                         :type => 'zip',
                         :headers => [
  ...
  # dependency
  # core
  s.dependency 'CartCore', '7.2.0-ECOM489.1'
  ...
  # Loyalty
  s.dependency 'LoyaltyComponent', '5.2.0-ECOM489.2'
