...
Pod::Spec.new do |s|
  s.name             = 'CartUI'
  s.version          = '5.1.0-OMNI1584.1589.1576.5'
  ...
  s.source           = {
                         :http => 'https://api.github.com/repos/teko-vn/Specs-ios/releases/assets/297124407',
                         :type => 'zip',
                         :headers => [
  ...
  # dependency
  # core
  s.dependency 'CartCore', '5.1.0-OMNI1584.1589.1576.5'
