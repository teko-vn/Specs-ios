...
Pod::Spec.new do |s|
  ...
  s.source           = {
                         :http => 'https://api.github.com/repos/teko-vn/Specs-ios/releases/assets/463071443',
                         :type => 'zip',
                         :headers => [
  ...
  # dependency
  # core
  s.dependency 'CartCore', '6.5.0-ECOM489.1'
  ...
  # Apollo
  s.dependency 'Apollo', '5.4.0-ECOM489.1'
  ...
  # Loyalty
  s.dependency 'LoyaltyComponent', '5.2.0-ECOM489.1'
