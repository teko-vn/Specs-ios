...
Pod::Spec.new do |s|
  s.name             = 'CartUI'
  s.version          = '3.2.0-OMNI1540154115521553.1'
  ...
  s.source           = {
                         :http => 'https://api.github.com/repos/teko-vn/Specs-ios/releases/assets/250318673',
                         :type => 'zip',
                         :headers => [
  ...
  # dependency
  # core
  s.dependency 'CartCore', '3.2.0-OMNI1540154115521553.1'
