...
Pod::Spec.new do |s|
  ...
  s.source           = {
                         :http => 'https://api.github.com/repos/teko-vn/Specs-ios/releases/assets/585703333',
                         :type => 'zip',
                         :headers => [
  ...
  # dependency
  # core
  s.dependency 'CartCore', '7.7.0-ISSUE924.1'
  ...
  # Loyalty
  s.dependency 'LoyaltyComponent', '~> 5.2'
