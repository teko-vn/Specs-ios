...
Pod::Spec.new do |s|
    s.name             = 'TekBankingService'
    s.version          = '4.0.0'
    s.summary          = 'Catalog service'
  ...
  TODO: Add long description of the pod here.
    ...
    s.source           = {
                           :http => 'https://api.github.com/repos/teko-vn/Specs-ios/releases/assets/242805426',
                           :type => 'zip',
                           :headers => [
    ...
    s.vendored_frameworks = 'TekBankingService.xcframework'
