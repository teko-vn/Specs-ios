...
Pod::Spec.new do |s|
    s.name             = 'TekTicketService'
    s.version          = '4.0.0'
    s.summary          = 'Ticket Service'
  ...
  TODO: Add long description of the pod here.
    ...
    s.source           = {
                           :http => 'https://api.github.com/repos/teko-vn/Specs-ios/releases/assets/242826814',
                           :type => 'zip',
                           :headers => [
    ...
    s.vendored_frameworks = 'TekTicketService.xcframework'
