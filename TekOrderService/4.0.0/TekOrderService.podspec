...
Pod::Spec.new do |s|
  s.name             = 'TekOrderService'
  s.version          = '4.0.0'
  s.summary          = 'Order service'
...
TODO: Add long description of the pod here.
  ...
  s.source           = {
                         :http => 'https://api.github.com/repos/teko-vn/Specs-ios/releases/assets/242811726',
                         :type => 'zip',
                         :headers => [
  ...
  s.vendored_frameworks = 'TekOrderService.xcframework'
