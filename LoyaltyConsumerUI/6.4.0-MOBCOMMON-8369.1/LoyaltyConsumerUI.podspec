Pod::Spec.new do |s|
    ...
    s.version          = '6.4.0-MOBCOMMON-8369.1'
  ...
  TODO: Add long description of the pod here.
    ...
    s.source           = {
                           :http => 'https://api.github.com/repos/teko-vn/Specs-ios/releases/assets/332010891',
                           :type => 'zip',
                           :headers => [
    ...
    s.dependency 'LoyaltyCore', '5.4.0-MOBCOMMON-8369.1'
