Pod::Spec.new do |s|
    ...
    s.version          = '6.3.0-MOBCOMMON7307.1'
  ...
  TODO: Add long description of the pod here.
    ...
    s.source           = {
                           :http => 'https://api.github.com/repos/teko-vn/Specs-ios/releases/assets/292439122',
                           :type => 'zip',
                           :headers => [
    ...
    s.dependency 'LoyaltyCore', '5.1.0-MOBCOMMON7307.1'
