...
Pod::Spec.new do |s|
    s.name             = 'CartPaymentUISDK'
    s.version          = '5.5.0-REPAYMENT.1'
    s.summary          = 'CartPaymentUISDK for mini app'
  ...
  TODO: Add long description of the pod here.
    ...
    s.source           = {
                           :http => 'https://api.github.com/repos/teko-vn/Specs-ios/releases/assets/565064542',
                           :type => 'zip',
                           :headers => [
    ...
    # dependency
    s.dependency 'CartPaymentCoreSDK', '~> 5.0'
    s.dependency 'Hermes', '~> 3.0'
    s.dependency 'TekLocalize', '~> 2.0'
    s.dependency 'Apollo', '~> 5.2'
