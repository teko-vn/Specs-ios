Pod::Spec.new do |s|
  ...
  TODO: Add long description of the pod here.
    ...
    s.source           = {
                           :http => 'https://api.github.com/repos/teko-vn/Specs-ios/releases/assets/431822812',
                           :type => 'zip',
                           :headers => [
    ...
    s.dependency 'Apollo', '5.3.0-OMNI1632.2'
    s.dependency 'ApolloTheme', '3.2.0-OMNI1632.2'
    s.dependency 'TekDiscoveryEvent', '~> 13.0'
