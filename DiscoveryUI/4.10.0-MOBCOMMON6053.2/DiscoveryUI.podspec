Pod::Spec.new do |s|
    s.name             = 'DiscoveryUI'
    s.version          = '4.10.0-MOBCOMMON6053.2'
  ...
  TODO: Add long description of the pod here.
    ...
    s.source           = {
                           :http => 'https://api.github.com/repos/teko-vn/Specs-ios/releases/assets/226796127',
                           :type => 'zip',
                           :headers => [
    ...
    s.dependency 'ShopFrontWebCoreSDK', '~> 1.1'
    ...
    s.dependency 'TekDiscoveryEvent', '10.0.0-MOBCOMMON6053.1'
    s.dependency 'TekLocalize', '~> 1.0'
    s.dependency 'TekoTracker', '~> 2.2'
  end
