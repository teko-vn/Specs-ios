...
Pod::Spec.new do |s|
    s.name             = 'TekSearchService'
    s.version          = '5.0.0'
    s.summary          = 'Search service'
  ...
  TODO: Add long description of the pod here.
    ...
    s.source           = {
                           :http => 'https://api.github.com/repos/teko-vn/Specs-ios/releases/assets/242825410',
                           :type => 'zip',
                           :headers => [
    ...
    s.vendored_frameworks = 'TekSearchService.xcframework'
