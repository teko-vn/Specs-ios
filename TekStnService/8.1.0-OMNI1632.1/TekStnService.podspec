...
Pod::Spec.new do |s|
    ...
    s.version          = '8.1.0-OMNI1632.1'
    s.summary          = 'StnService of Tek.'
  ...
  TODO: Add long description of the pod here.
    ...
    s.source           = {
                           :http => 'https://api.github.com/repos/teko-vn/Specs-ios/releases/assets/443359512',
                           :type => 'zip',
                           :headers => [
    ...
    s.vendored_frameworks = 'TekStnService.xcframework'
