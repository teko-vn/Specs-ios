Pod::Spec.new do |s|
    ...
    s.version          = '4.8.0-MOBCOMMON7523.1'
  ...
  TODO: Add long description of the pod here.
    ...
    s.source           = {
                           :http => 'https://api.github.com/repos/teko-vn/Specs-ios/releases/assets/275473983',
                           :type => 'zip',
                           :headers => [
    ...
    s.dependency 'TekDiscoveryEvent', '11.0.0-MOBCOMMON7523.1'
