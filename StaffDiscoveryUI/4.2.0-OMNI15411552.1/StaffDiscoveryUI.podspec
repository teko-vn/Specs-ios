Pod::Spec.new do |s|
    ...
    s.version          = '4.2.0-OMNI15411552.1'
  ...
  TODO: Add long description of the pod here.
    ...
    s.source           = {
                           :http => 'https://api.github.com/repos/teko-vn/Specs-ios/releases/assets/250350542',
                           :type => 'zip',
                           :headers => [
    ...
    s.dependency 'TekDiscoveryEvent', '10.2.0-OMNI15411552.1'
