Pod::Spec.new do |s|
    ...
    s.version          = '4.13.0-OMNI1612-phase2.2'
  ...
  TODO: Add long description of the pod here.
    ...
    s.source           = {
                           :http => 'https://api.github.com/repos/teko-vn/Specs-ios/releases/assets/309657252',
                           :type => 'zip',
                           :headers => [
    ...
    s.dependency 'TekDiscoveryEvent', '11.5.0-OMNI1612.1'
