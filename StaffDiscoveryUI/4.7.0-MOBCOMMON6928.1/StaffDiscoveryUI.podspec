Pod::Spec.new do |s|
    ...
    s.version          = '4.7.0-MOBCOMMON6928.1'
  ...
  TODO: Add long description of the pod here.
    ...
    s.source           = {
                           :http => 'https://api.github.com/repos/teko-vn/Specs-ios/releases/assets/270996127',
                           :type => 'zip',
                           :headers => [
    ...
    s.dependency 'TekDiscoveryEvent', '10.4.0-MOBCOMMON6928.1'
