...
Pod::Spec.new do |s|
    ...
    s.version          = '11.2.0-MOBCOMMON7611.1'
  ...
  TODO: Add long description of the pod here.
    ...
    s.source           = {
                           :http => 'https://api.github.com/repos/teko-vn/Specs-ios/releases/assets/275551495',
                           :type => 'zip',
                           :headers => [
    ...
    s.vendored_frameworks = 'TekUserService.xcframework'
