...
Pod::Spec.new do |s|
  ...
  TODO: Add long description of the pod here.
    ...
    s.source           = {
                           :http => 'https://api.github.com/repos/teko-vn/Specs-ios/releases/assets/424073779',
                           :type => 'zip',
                           :headers => [
    ...
    s.dependency 'TerraUtilities', '~> 3.0'
