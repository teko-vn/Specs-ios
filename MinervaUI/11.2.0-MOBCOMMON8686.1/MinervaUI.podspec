...
Pod::Spec.new do |s|
    s.name             = 'MinervaUI'
    s.version          = '11.2.0-MOBCOMMON8686.1'
  ...
  TODO: Add long description of the pod here.
    ...
    s.source           = {
                           :http => 'https://api.github.com/repos/teko-vn/Specs-ios/releases/assets/375490902',
                           :type => 'zip',
                           :headers => [
    ...
    s.dependency 'Minerva', '11.2.0-MOBCOMMON8686.1'
