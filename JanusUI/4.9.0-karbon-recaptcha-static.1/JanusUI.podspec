Pod::Spec.new do |s|
    s.name             = 'JanusUI'
    s.version          = '4.9.0-karbon-recaptcha-static.1'
  ...
  TODO: Add long description of the pod here.
    ...
    s.source           = {
                           :http => 'https://api.github.com/repos/teko-vn/Specs-ios/releases/assets/380144929',
                           :type => 'zip',
                           :headers => [
