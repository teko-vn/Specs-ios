Pod::Spec.new do |s|
    ...
    s.version          = '11.4.0-MOBCOMMON7756.1'
  ...
  TODO: Add long description of the pod here.
    ...
    s.source           = {
                           :http => 'https://api.github.com/repos/teko-vn/Specs-ios/releases/assets/304030807',
                           :type => 'zip',
                           :headers => [
    ...
    s.dependency 'TekDiscoveryCore', '~> 6.5'
    s.dependency 'TekPpmService', '2.1.0-MOBCOMMON7756.1'
