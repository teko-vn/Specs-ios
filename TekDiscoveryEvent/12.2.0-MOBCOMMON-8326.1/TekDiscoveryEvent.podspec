Pod::Spec.new do |s|
    ...
    s.version          = '12.2.0-MOBCOMMON-8326.1'
  ...
  TODO: Add long description of the pod here.
    ...
    s.source           = {
                           :http => 'https://api.github.com/repos/teko-vn/Specs-ios/releases/assets/327274960',
                           :type => 'zip',
                           :headers => [
    ...
    s.dependency 'TekDiscoveryCore', '6.10.0-MOBCOMMON-8326.1'
    s.dependency 'TekPpmService', '~> 4.1'
    s.dependency 'TekTempiService', '3.1.0-MOBCOMMON-8326.1'
