Pod::Spec.new do |s|
    ...
    s.version          = '12.4.0-MOBCOMMON-8326.1'
  ...
  TODO: Add long description of the pod here.
    ...
    s.source           = {
                           :http => 'https://api.github.com/repos/teko-vn/Specs-ios/releases/assets/329662195',
                           :type => 'zip',
                           :headers => [
    ...
    s.dependency 'TekTempiService', '3.3.0-MOBCOMMON-8326.1'
