Pod::Spec.new do |s|
    ...
    s.version          = '10.3.0-MOBCOMMON6268.1'
  ...
  TODO: Add long description of the pod here.
    ...
    s.source           = {
                           :http => 'https://api.github.com/repos/teko-vn/Specs-ios/releases/assets/260441010',
                           :type => 'zip',
                           :headers => [
    ...
    s.dependency 'TekDiscoveryCore', '~> 6.1'
    s.dependency 'TekPpmService', '~> 4.0'
    s.dependency 'TekTempiService', '2.1.0-MOBCOMMON6268.1'
