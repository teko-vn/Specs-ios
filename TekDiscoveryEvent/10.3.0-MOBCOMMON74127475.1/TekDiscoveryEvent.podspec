Pod::Spec.new do |s|
    ...
    s.version          = '10.3.0-MOBCOMMON74127475.1'
  ...
  TODO: Add long description of the pod here.
    ...
    s.source           = {
                           :http => 'https://api.github.com/repos/teko-vn/Specs-ios/releases/assets/263867201',
                           :type => 'zip',
                           :headers => [
    ...
    s.dependency 'TekDiscoveryCore', '6.2.0-MOBCOMMON74127475.1'
    s.dependency 'TekPpmService', '~> 4.0'
    s.dependency 'TekTempiService', '2.1.0-MOBCOMMON74127475.1'
