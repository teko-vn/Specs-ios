Pod::Spec.new do |s|
  ...
  TODO: Add long description of the pod here.
    ...
    s.source           = {
                           :http => 'https://api.github.com/repos/teko-vn/Specs-ios/releases/assets/263864493',
                           :type => 'zip',
                           :headers => [
    ...
    s.dependency 'TekDiscoveryCore', '6.2.0-MOBCOMMON7412.2'
    s.dependency 'TekPpmService', '~> 4.0'
    s.dependency 'TekTempiService', '2.1.0-MOBCOMMON7412.2'
