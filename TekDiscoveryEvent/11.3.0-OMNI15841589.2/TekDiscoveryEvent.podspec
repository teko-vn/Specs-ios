Pod::Spec.new do |s|
    ...
    s.version          = '11.3.0-OMNI15841589.2'
  ...
  TODO: Add long description of the pod here.
    ...
    s.source           = {
                           :http => 'https://api.github.com/repos/teko-vn/Specs-ios/releases/assets/296233801',
                           :type => 'zip',
                           :headers => [
    ...
    s.dependency 'TekLocationService', '5.1.0-OMNI1589.1'
