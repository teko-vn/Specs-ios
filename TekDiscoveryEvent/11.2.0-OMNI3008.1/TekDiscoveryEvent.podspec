Pod::Spec.new do |s|
  ...
  TODO: Add long description of the pod here.
    ...
    s.source           = {
                           :http => 'https://api.github.com/repos/teko-vn/Specs-ios/releases/assets/283977394',
                           :type => 'zip',
                           :headers => [
    ...
    s.dependency 'TekDiscoveryCore', '6.5.0-OMNI3008.1'
    s.dependency 'TekPpmService', '~> 4.0'
    s.dependency 'TekTempiService', '2.2.0-OMNI3008.1'
