Pod::Spec.new do |s|
    ...
    s.version          = '11.5.0-MOBCOMMON-7761.1'
  ...
  TODO: Add long description of the pod here.
    ...
    s.source           = {
                           :http => 'https://api.github.com/repos/teko-vn/Specs-ios/releases/assets/307240118',
                           :type => 'zip',
                           :headers => [
    ...
    s.dependency 'TekListingService', '5.1.0-MOBCOMMON-7761.1'
    s.dependency 'TekPolicyService', '~> 6.0'
    s.dependency 'TekSearchService', '~> 5.0'
    s.dependency 'TekDiscoveryCore', '6.7.0-MOBCOMMON-7761.1'
