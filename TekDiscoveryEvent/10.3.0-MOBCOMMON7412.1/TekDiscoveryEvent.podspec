Pod::Spec.new do |s|
    ...
    s.version          = '10.3.0-MOBCOMMON7412.1'
  ...
  TODO: Add long description of the pod here.
    ...
    s.source           = {
                           :http => 'https://api.github.com/repos/teko-vn/Specs-ios/releases/assets/261169680',
                           :type => 'zip',
                           :headers => [
    ...
    s.dependency 'TekDiscoveryCore', '6.2.0-MOBCOMMON7412.1'
    s.dependency 'TekPpmService', '~> 4.0'
    s.dependency 'TekTempiService', '2.1.0-MOBCOMMON7412.1'
