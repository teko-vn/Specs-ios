Pod::Spec.new do |s|
    ...
    s.version          = '12.0.0-OMNI1612phase3.1'
  ...
  TODO: Add long description of the pod here.
    ...
    s.source           = {
                           :http => 'https://api.github.com/repos/teko-vn/Specs-ios/releases/assets/315005689',
                           :type => 'zip',
                           :headers => [
    ...
    s.dependency 'TekTempiService', '3.0.0-OMNI1612phase3.1'
