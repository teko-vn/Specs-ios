Pod::Spec.new do |s|
    ...
    s.version          = '9.3.0-MOBCOMMON7111.1'
  ...
  TODO: Add long description of the pod here.
    ...
    s.source           = {
                           :http => 'https://api.github.com/repos/teko-vn/Specs-ios/releases/assets/236103431',
                           :type => 'zip',
                           :headers => [
    ...
    s.dependency 'TekDiscoveryCore', '5.4.0-MOBCOMMON7111.1'
