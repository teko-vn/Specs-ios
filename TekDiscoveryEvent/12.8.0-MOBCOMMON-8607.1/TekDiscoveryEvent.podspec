Pod::Spec.new do |s|
    ...
    s.version          = '12.8.0-MOBCOMMON-8607.1'
  ...
  TODO: Add long description of the pod here.
    ...
    s.source           = {
                           :http => 'https://api.github.com/repos/teko-vn/Specs-ios/releases/assets/372934676',
                           :type => 'zip',
                           :headers => [
    ...
    s.dependency 'TekDiscoveryCore', '6.12.0-MOBCOMMON-8607.1'
