...
Pod::Spec.new do |s|
    s.name             = 'TekCovOrderService'
    s.version          = '4.0.0'
    s.summary          = 'Cov order service'
  ...
  TODO: Add long description of the pod here.
    ...
    s.source           = {
                           :http => 'https://api.github.com/repos/teko-vn/Specs-ios/releases/assets/242806670',
                           :type => 'zip',
                           :headers => [
    ...
    s.vendored_frameworks = 'TekCovOrderService.xcframework'
